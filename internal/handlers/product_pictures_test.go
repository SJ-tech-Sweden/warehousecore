...
func (f *fakePictureService) ListPictures(productName string) ([]services.ProductPictureInfo, error) { return []services.ProductPictureInfo{}, nil }
func (f *fakePictureService) UploadPicture(productName string, file multipart.File, header *multipart.FileHeader) (string, error) { return "stored.png", nil }
func (f *fakePictureService) DeletePicture(productName, fileName string) error { return nil }
func (f *fakePictureService) DownloadPictureWithVariant(productName, fileName, variant, format string) (io.ReadCloser, string, error) { return nil, "image/png", nil }
