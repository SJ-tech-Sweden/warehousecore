...
func (t *testLabelService) GetTemplateByID(id int) (*models.LabelTemplate, error) { return &models.LabelTemplate{}, nil }
...
func (t *testLabelService) SaveLabelImage(deviceID, imageData string) (string, error) { return "/labels/ok.png", nil }
func (t *testLabelService) SaveCaseLabelImage(caseID int, imageData string) (string, error) { return "/labels/case.png", nil }
func (t *testLabelService) SaveZoneLabelImage(zoneID int64, imageData string) (string, error) { return "/labels/zone.png", nil }
